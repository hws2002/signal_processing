...
- **Hardware**: Intel(R) Core(TM) i5-1220H (2.70 GHz), CPU-only training
  - CPU count: 12
...
- MSE 从 0.047 ($N=2$) 降至 0.0026 ($N=128$)，提升约 **18倍**
- MAE 从 0.170 ($N=2$) 降至 0.0096 ($N=128$)，提升约 **17.7倍**
- **Max Error 始终保持 0.5**，这是方波信号的固有特性
...
| 特征 | 方波 (Square Wave) | 半圆波 (Semicircle Wave) |
|------|-------------------|------------------------|
